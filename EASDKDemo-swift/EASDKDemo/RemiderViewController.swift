...
class RemiderViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 0: Cmd_Reminder.getData();break
        case 1: Cmd_Reminder.add();break
        case 2: Cmd_Reminder.edit();break
        case 3: Cmd_Reminder.deleteOne();break
        case 4: Cmd_Reminder.deleteAll();break
        default:break;
        }
    }
}
